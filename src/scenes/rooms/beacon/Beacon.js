...
// Beacon (top of the Lighthouse), ported from the Yukon CPJourney asset set. Faithful layered art,
// the pull-handle that toggles the beacon light on/off, the jetpack hover animation, and the hatch
// down to the Lighthouse. The Jetpack Adventure game + telescope widget are omitted for now.
...
export default class Beacon extends RoomScene {
    ...
    _create() {
        ...
        // rectangle_invalid (handle hover zone)
    ...
    toggleLight() {
        ...
        this.inner0001.setTexture('beacon_inner_two', this.handle0001.__HoverAnimation.currentAnimation == 1 ? 'inner0002' : 'inner0001')
    }
