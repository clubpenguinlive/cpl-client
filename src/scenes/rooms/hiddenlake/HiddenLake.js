...
// Hidden Lake, ported from the Yukon CPJourney asset set. Faithful layered art with the full set of
// water animations (waterfalls, waves, splashes, surface ripple) and the sparkle stars. Exit up to the
// Forest. The Cave-Mine (813) and Underwater (not yet ported) links are omitted.
...
export default class HiddenLake extends RoomScene {
    ...
    _create() {
        ...
        // animations
        const mk = (obj, key, end) => { const a = new Animation(obj); a.key = key; a.end = end; };
        mk(animations_wave0001, "animations/wave", 250);
        mk(animations_left_water_fall0001, "animations/left_water_fall", 30);
        mk(animations_right_water_fall0001, "animations/right_water_fall", 30);
        mk(animations_top_left_water0001, "animations/top_left_water", 30);
        mk(animations_top_left_water20001, "animations/top_left_water2", 30);
        mk(animations_top_right_water0001, "animations/top_right_water", 30);
        mk(animations_top_right_water20001, "animations/top_right_water2", 30);
        mk(animations_right_bottom_water0001, "animations/right_bottom_water", 30);
        mk(animations_right_bottom_water20001, "animations/right_bottom_water2", 30);
        mk(animations_left_bottom_water0001, "animations/left_bottom_water", 30);
        mk(animations_left_bottom_water20001, "animations/left_bottom_water2", 30);
        mk(animations_right_water_splash0001, "animations/right_water_splash", 12);
        mk(animations_left_water_splah0001, "animations/left_water_splah", 12);
        mk(animations_star1_0001, "animations/star1_", 52);
        mk(animations_star2_0001, "animations/star2_", 52);
        mk(animations_star30001, "animations/star3", 52);
        mk(animations_star40001, "animations/star4", 52);
        mk(animations_star50001, "animations/star5", 52);
