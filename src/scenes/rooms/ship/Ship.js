...
// The Migrator (Rockhopper's ship), ported from the Yukon CPJourney asset set. Faithful layered deck
// art + the ladder hover animation + the exit down to the Beach. The below-deck rooms (hold / nest /
// quarters) are not wired yet, so those triggers are omitted.
...
export default class Ship extends RoomScene {
    ...
    _create() {
        ...
        // rectangle (ladder hover hotspot)
        ...
        // rectangle (components) - hover plays the ladder animation
