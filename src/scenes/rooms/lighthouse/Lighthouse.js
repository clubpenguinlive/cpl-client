...
// Lighthouse, ported from the Yukon CPJourney asset set. Faithful layered art + ambient speaker
// animations + the rooftop hatch (-> Beacon) and door (-> Beach). The band layered-music easter egg
// is omitted (needs the instrument/stamp subsystem we don't run yet).
...
export default class Lighthouse extends RoomScene {
    ...
    constructor() {
        ...
        this.roomTriggers = {
            ...
            'beacon': () => this.triggerRoom(420, 272, 680)
        }
        /* END-USER-CTR-CODE */
    }
    ...
    _create() {
        ...
        // top0001 (components) - rooftop hatch up to the Beacon
        ...
        top0001SimpleButton.callback = () => { this.triggerRoom(420, 272, 680) };

        // door (components) - down to the Beach
