...
// Mine, ported from the Yukon CPJourney asset set. Faithful layered art + ambient animations
// (the entrance lift, swinging lights, candle, puffle, telephone) plus the Cart Surfer hotspot
// (-> game 905, our Mining skill) and the exit to the Cave. The puffle-rescue and cave-mine
// links are omitted (those rooms/games are not wired yet).
...
export default class Mine extends RoomScene {
    ...
    _create() {
        ...
        // lists
        const sort = [foreground, minesign, cart1, shovel, cart2, wood, cavewallfront, rocks, chair, _table, equipment];
        ...
        // cartbtn (components) - Cart Surfer hotspot (game 905 / Mining)
